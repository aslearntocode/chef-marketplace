...
export default function AccessoryProductPageClient({ params }: AccessoryProductPageClientProps) {
  const { id } = use(params);
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="border rounded-lg">
                  <button
                    ...
                    className="flex items-center justify-between w-full p-4 text-left"
                  >
                    <span className="font-medium">Product Features & Benefits</span>
                  ...
                  {openSection === 'ingredients' && (
                    <div className="px-4 pb-4">
                      {product.ingredients_benefits && Object.keys(product.ingredients_benefits).length > 0 ? (
                        <div className="space-y-4">
                          <div>
                            <ol className="list-decimal list-inside text-gray-600 space-y-1 font-bold">
                              {Object.entries(product.ingredients_benefits).map(([feature, benefits], index) => (
                                <li key={index}>
                        ...
                        <p className="text-gray-600">Features and benefits information not available</p>
                      )}
                    </div>
                  )}
                </div>
