...
export default function ProductPageClient({ params }: ProductPageProps) {
  ...
  const handleAddToCart = async () => {
    ...
    const cartItem = {
      ...
      quantity: 1,
      vendor_id: 'sauces-and-dressings',
      ...
      {isZoomModalOpen && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => setIsZoomModalOpen(false)}
              className="absolute top-4 right-4 text-white hover:text-gray-300 z-[10000] bg-black bg-opacity-80 rounded-full p-3 shadow-lg border-2 border-white/20"
            >
            ...
            {images.length > 1 && (
              <button
                onClick={() => handleImageNav('prev')}
                className="absolute left-4 top-1/2 transform -translate-y-1/2 text-white hover:text-gray-300 z-[10000] bg-black bg-opacity-80 rounded-full p-3 shadow-lg border-2 border-white/20"
              >
            ...
            {images.length > 1 && (
              <button
                onClick={() => handleImageNav('next')}
                className="absolute right-4 top-1/2 transform -translate-y-1/2 text-white hover:text-gray-300 z-[10000] bg-black bg-opacity-80 rounded-full p-3 shadow-lg border-2 border-white/20"
              >
            ...
            {/* Image Counter */}
            {images.length > 1 && (
              <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-white bg-black bg-opacity-80 rounded-full px-4 py-2 text-sm shadow-lg border border-white/20">
